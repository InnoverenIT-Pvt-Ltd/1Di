...
export class PlannerCalendar extends Component {
  ...
  componentDidMount() {
    ...
    getHourListByUserId(userId,startDate, endDate);
...
const mapStateToProps = ({ auth, planner, call, event, task, holiday, project }) => ({
  userId: auth.userDetails.userId,
   hourListByUserId:planner.hourListByUserId,
