        ...
        {/* {Object.keys(props.productsByproductId).map((key) => (
         ...
         <tr  className="bg-gray-50 odd:bg-white">
          ...
          <tr  className="bg-gray-50 odd:bg-white">
            ...
            <td className="p-2 border border-gray-200">{props.productsByproductId.hsn}</td>
          </tr>
<tr  className="bg-gray-50 odd:bg-white">
          ...
          <tr  className="bg-gray-50 odd:bg-white">
            ...
            <td className="p-2 border border-gray-200">{props.productsByproductId.netWeight}</td>
          </tr>
          <tr  className="bg-gray-50 odd:bg-white">
            <th className="p-2 text-left font-medium text-gray-600 border border-gray-200">Attribute</th>
            <td className="p-2 border border-gray-200">{props.productsByproductId.attributeName} {props.productsByproductId.subAttributeName}</td>
          </tr>
          <tr  className="bg-gray-50 odd:bg-white">
            <th className="p-2 text-left font-medium text-gray-600 border border-gray-200">Category</th>
            <td className="p-2 border border-gray-200">{props.productsByproductId.categoryName} {props.productsByproductId.subCategoryName}</td>
          </tr>
      </tbody>
    </table>
  );
