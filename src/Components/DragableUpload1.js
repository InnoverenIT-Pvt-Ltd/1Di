...
class DragableUpload1 extends React.Component {
    state = {
    ...
    handleDocumentUpload = ({ onSuccess, onError, file }) => {
        ...
        axios
            ...
            .then(res => {
                ...
                this.props.handleSetVideo(res.data)
            ...
            <div className="clearfix">
                ...
                >
                    ...
                    <p className="ant-upload-text">
                        Click or drag file here or click to upload
                    </p>
                </Dragger>
            </div>
        );
...
export default DragableUpload1;
