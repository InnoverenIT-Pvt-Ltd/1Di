...
function SuplrInventoryDrawerForm(props) {
  useEffect(() => {
  ...
  const handleSubmit = () => {
    ...
    // Make the API call
    props.addSupplrInventory(dataToSend, props.userId,"0");
  ...
  return (
    <>
      <div>
          ...
          <div key={index}>
            ...
            <div>
                ...
                <div className="w-[7rem]">
                 ...
                 >
                    {props.allproductsCategory.map((a) => (
        ...
        <Button type="primary" loading={props.addingSuplrInventory} onClick={handleSubmit}>Submit</Button></div>
      </div>
...
const mapStateToProps = ({ distributor, brandmodel, auth,inventory }) => ({
...
//   token: auth.token,
  saleCurrencies:inventory.saleCurrencies,
  allproductsCategory:inventory.allproductsCategory,
  allProduct:inventory.allProduct,
  locationlist:inventory.locationlist,
  addingSuplrInventory:inventory.addingSuplrInventory
});
...
export default connect(mapStateToProps, mapDispatchToProps)(SuplrInventoryDrawerForm);
