...
function CancelledOrderInProgressCard(props) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true); 
            try {
                const response = await axios.get(`${base_url2}/cancellorders/dummy/${pageNo}`,{
                    headers: {
...
export default connect(mapStateToProps, mapDispatchToProps)(CancelledOrderInProgressCard);
