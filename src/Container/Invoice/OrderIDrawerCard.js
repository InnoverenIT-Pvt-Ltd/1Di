...
function OrderIDrawerCard(props) {
  ...
  useEffect(() => {
    const fetchData1 = async () => {
        try {
          const response = await axios.get(`${base_url2}/orderidummy/${props.userId}/${props.rowDatas.procureOrderInvoiceId}`,{
            headers: {
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderIDrawerCard);
