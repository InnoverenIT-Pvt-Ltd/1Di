...
class OrderNoteFile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <>
        <Formik
          ...
          onSubmit={(values, { resetForm }) => {
            ...
            this.props.postFeedbackOrder({ ...values, feedback: htmlBody },this.props.orderId,this.createCallback);
            resetForm();
          }}
        >
          {({
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderNoteFile);
