...
function ProcureQuotationItemView (props) {
...
const [error, setError] = useState(null);
  ...
  const fetchQuotationItems = async () => {
    try {
      const response = await axios.get(`${base_url2}/quotation/procure/order/${props.rowDatas.quotationId}`,{
        headers: {
          Authorization: "Bearer " + sessionStorage.getItem("token") || "",
        },
      });
...
<div className=" md:w-[10rem]"><FormattedMessage
                         ...
                         <div className=" md:w-[6.5rem]"><FormattedMessage
                                    ...
                                    <InfiniteScroll
                                        dataLength={QuotationItems.length}
