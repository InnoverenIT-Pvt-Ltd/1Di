...
function CancelledInvoiceCard(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
        setLoading(true); 
        try {
            const response = await axios.get(`${hrErp}/dummy/repair/contact/${props.userId}/${pageNo}`,{
                headers: {
...
export default connect(mapStateToProps, mapDispatchToProps)(CancelledInvoiceCard);
