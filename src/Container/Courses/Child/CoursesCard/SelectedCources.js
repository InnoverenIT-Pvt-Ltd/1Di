...
const { Option } = Select;
class SelectedCources extends Component {
//   state = {
//     value: 1,
//     currentData: "",
//     visbleNewUI: false,
...
//   };
  ...
  render() {
   // const { value } = this.state;
    ...
    console.log("courses1",this.props.selcted.courses)
          ...
          {/* {this.props.shopName.openInd ? ( */}
            <>
              {/* {!this.state.visbleNewUI ? ( */}
                <CardWrapper>
                   {this.props.selcted.courses.map((item) => {
                    return ( 
                      <CardElement >
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectedCources);
