...
function DashboardJumpStart (props) {
...
<JumpStartBox1
            ...
            cursorData={"pointer"}
            borderD={props.activeTable ==='open' ? "3px solid tomato":""}
          ...
          <JumpStartBox2
            ...
            cursorData={"pointer"}
            borderD={props.activeTable ==='complete' ? "3px solid tomato":""}
          ...
          <JumpStartBox3
            ...
            borderD={props.activeTable ==='cancelled' ? "3px solid tomato":""}
            cursorData={"pointer"}
